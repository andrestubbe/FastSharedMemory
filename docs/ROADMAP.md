# FastSharedMemory Roadmap 🗺️

**Vision:** To provide the fastest possible native primitives for shared memory by aggressively bypassing bottlenecks in standard Java.
